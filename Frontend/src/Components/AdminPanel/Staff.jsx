  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-semibold text-gray-800">Staff Member</h1>
    ...
    {showForm && (
        <div className="top-2 mt-18 z-50 left-47 md:left-[38%] w-96 absolute bg-white shadow-md rounded-lg p-4">
         ...
         {/* Overlay for Background Blur for staff*/}
    {showEditForm && (
        <div className="fixed inset-0 bg-black/30 bg-opacity-50 backdrop-blur-sm z-10"></div>
      )}
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="hover:bg-gray-300">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Work</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200 hover:bg-gray-300">
            <tr>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 capitalize">Mr.Ram Pal</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">30</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">Arjun Pal</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 capitalize">Driver</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 ">05-03-2023</td>
